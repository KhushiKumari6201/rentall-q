          ...
          {COMPANIES.map((company) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative rounded-2xl border border-stone-200 bg-white p-6 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-default ${accent.glow}`}
              >
